      ...
      <div className="max-w-md w-full bg-white rounded-xl shadow-md p-8">
        ...
        <div className="mt-6 border-t border-gray-100 pt-6">
          <button 
            ...
            className="w-full py-2 text-gray-500 hover:text-gray-800 transition text-sm flex items-center justify-center gap-2"
          >
            {guestSubmitting ? (
              <span className="animate-pulse">Launching Guest Mode...</span>
            ) : (
              <>Don't want an account? <span className="font-bold underline text-gray-700">Try Guest Mode</span></>
            )}
          </button>
        </div>
